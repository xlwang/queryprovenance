...
public class Solution {
	...
	public QueryLog onePassSolution(IloCplex cplex, 
			...
			boolean falsepositive, boolean oneerr, String[] args) throws Exception {
		...
		if(oneerr) {
			for(int cand : candidate) {
				...
				curcand.add(cand);
				qlogfix = linearsolver.fixParameters(cplex, badInitialDs.getTable(), badQueries, badDss, complaints, curcand, cand, badQueries.size());

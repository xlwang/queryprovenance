...
and F1 measure (the harmonic mean of precision and recall). \xlw{Note that we consider a log repair accurate as 
...
\xlw{Also, despite tuple-slicing's refinement step, the repair could over generalize and ``fix'' the wrong records with insufficient information, leading to low precision.}

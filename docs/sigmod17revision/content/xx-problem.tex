...
\xlw{Ideally, each complaint will denote a \textbf{complete value correction} in that the {\emph correct} values are provided for {\emph all} tuple attributes.  
This constrains the research space to more quickly produce higher quality diagnoses.  
We assume such a setting in this paper and leave relaxations of this constraint to future work.}
...
Future work will study efficient techniques for multiple corrupt queries and incomplete value corrections.}

...
Similar to query slicing, this optimization simply removes irrelevant attributes through static analysis of the query log.  Thus it reduces the problem size without any loss of accuracy.

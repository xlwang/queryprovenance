...
$d(\mathcal{Q},\mathcal{Q}^*)$ is minimized. \newtext{In fact, the optimal diagnosis problem follows
the intuition, seeking for minimum changes, that has been applied similarly in many existing data repair problems~\cite{dallachiesa2013nadeef}. } In this section, we

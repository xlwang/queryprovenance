...
We provide two motivating examples, This is a real-life scenario, provided to us by a large US-based wireless provider.
\ewu{Consider the following motivating examples, the first is based on conversations with a large US-based wireless provider:}
...
harder to trace as the source of the errors is obscured.\footnote{This is a real-life scenario, provided to us by a large US-based wireless provider.}

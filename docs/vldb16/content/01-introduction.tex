...
\alex{Personally, I prefer the story we have already. Explanations
don't seem to fit well with the type of experiments we have. The
narrative would also have to change substantially in many other parts
of the paper...}
\ewu{Instead of talking about data cleaning and trashing it, maybe focus on the value of having explanations of the errors.  Maybe something like:
...
updates (\xlw{for ordered attributes} \alex{I don't understand this}), 
...
dataset, allow repairing the source of the errors, 
and potentially lead to the identification of additional discrepancies in

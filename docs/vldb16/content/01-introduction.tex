...
\begin{itemize}[leftmargin=*, topsep=0mm, itemsep=0mm]      
    ...
    \item We \ewu{perform a thorough evaluation of the trade-offs between speed and accuracy of our baseline and optimized methods under a controlled, synthetic setting.  

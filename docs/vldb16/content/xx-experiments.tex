...
% experiments. 
  \begin{figure*}[h]
    ...
    \begin{subfigure}[t]{.33\textwidth}
      ...
      %\vspace*{-.1in}
      \caption{Performance of different query types.}
      \label{f:qidx_time} 
    \end{subfigure}
    \begin{subfigure}[t]{.33\textwidth}
    ...
    \begin{subfigure}[t]{.33\textwidth}
      ...
      \vspace*{-.2in}
      \caption{False negatives vs F1-score.}
...
The x-axis varies the index of the corrupted query between $q_1$ and $q_249$.

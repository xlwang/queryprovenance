...
\label{sec:experiments}
  ...
  \centering
    ...
    \end{subfigure}
    \vspace*{-.1in}
    \caption{Prelim. experiments highlight limitations of \naive, the value of tuple-slicing, and high cost of \texttt{UPDATE} queries.}
    % \vspace*{-.15in}
  \end{figure*}
...
\subsection{Preliminary Analysis}
 ...
 \begin{figure*}[ht]
    ...
    \end{subfigure}
    \vspace*{-.1in}
    \caption{Optimization comparison illustrates value of query and attribute slicing when \# attributes is high.}
    % \vspace*{-.15in}
  \end{figure*}
...
% experiments. 
  \begin{figure*}[t]
    ...
    \end{subfigure}
    \vspace*{-.25in}
    \caption{Data and workload parameter experiments show high sensitivity to query skew, clause types, and dimensionality.  \sys can handle high false negative rates in recent queries.}
    % \vspace*{-.15in}
  \end{figure*}
...
\centering
  ...
  \vspace*{-.2in}
  \caption{Benchmark Experiments show low repair latencies on OLTP workloads.}
  \label{f:tpcctatp} 
  % \vspace*{-.1in}
\end{figure}

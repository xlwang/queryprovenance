...
the query log size for a database of $1000$ tuples.  The red bars encode the problem using \xlw{\emph{basic} algorithm that parameterize all queries } while the blue bars \xlw{shows the potential gain by 
only paramerizing a single (incorrect) query}.

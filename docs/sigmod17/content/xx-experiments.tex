...
\begin{figure}[!htb]
  ...
  \centering
    ...
    \end{subfigure}
    \vspace*{-.1in}
    \caption{Incomplete complaint sets improve repair performance due to less complaints; they affect the repair quality when the corruption is old. \xlw{(C. Age is short for Corruption Age.), legend does not fit one line with full label, replace with commented out lines for alternative figures.}}
  \end{figure}

...
We carefully study the complexity of update workloads and divide them 
...
\texttt{INSERT} query can also be considered as ``point update with primary key'' as it only impacts on a 

...
A cursory search of the news finds numerous reports of how data entry errors resulted in utility companies overcharging cities by millions of dollars~\cite{powercompany}, a state attorney prosecuting the wrong people~\cite{mosby}, and the Boston Police paying tens of millions of dollars for a new records system to combat data entry errors that ``riddled'' the previous system, which contained ``highly scrutinized stop-and-frisk information''.

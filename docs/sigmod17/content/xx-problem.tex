...
In this work, we assume basic data manipulation queries with no subqueries, aggregations, or joins; these operations are not as common in update workloads. 

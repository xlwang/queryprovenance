...
each of the slicing techniques reduces the problem and speeds up the solver time. \xlw{We demonstrate that under certain circumstances, applying optimizations is 40$\times$ faster than the basic approach. Detailed experiment results can be found in our technical report~\cite{qfixarxiv}.}

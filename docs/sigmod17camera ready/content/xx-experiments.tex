...
\newtext{\sys has two scalability bottlenecks: the limitations of MILP solvers
and the memory limitation of the machines. Our optimizations
ameliorate these issues, however, we observe that problems with $100$ attributes, $100k$ records, and
$250$ queries already come close to what we are able to solve at current stage.}

...
\sys uses additional optimizations not presented in this paper 
to scale to large query log and database sizes.  In fact, for common
transaction benchmarks, \sys can propose a solution within several seconds

...
\noindent {\bf Step 1:} Participants may first choose from a dropdown menu containing
...
\noindent {\bf Step 2:} Once the workload generator is specified, the Query Log component of the interface

...
of data errors based on the queries that operated on the dataset; (b)
...
optimizations techniques that improve our basic approach without
...
of \sys through extensive evaluation over real-world and synthetic
data.

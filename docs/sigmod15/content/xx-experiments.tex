...
picked from $V_d = [0, 100]$ uniformly at random, along with a primary key $id$.
...
\begin{table}[h]\small
  ...
  $idx$  & Index of corrupted query & $\frac{N_q}{2}$ \\
  $s$    & Skewness of query attributes, & $0$ \\
...
\subsection{Effect of Index of Corrupted Query}

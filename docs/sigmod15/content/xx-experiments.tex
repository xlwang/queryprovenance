...
optimizations that improve the scalability of the system over the naive
approach by over $Y\times$ and enable the algorithm to tolerate
incomplete complaint sets with minimal loss in accuracy.
...
In addition, we measure the repair's precision (percentage of repaired tuples that were correctly fixed), 

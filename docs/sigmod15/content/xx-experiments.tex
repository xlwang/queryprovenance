...
query types.
Thus, our subsequent synthetic experiments focus solely on the more difficult \texttt{UPDATE}-only cases, with a single corrupted query,
and study the different incremental repair algorithms.
}

...
\ewu{many data cleaning systems try to identify structural sources of dirtiness, but can only do it at a surface level.  They would never be able to identify those caused by a faulty query!}
...
harder to trace as the source of the errors is obscured.\footnote{This is a real-life scenario, provided to us by a US-based wireless provider. \alex{I added this for some gravitas.  Does it help?  Should we be more specific, or mention anything else?}}
...
\begin{itemize}[leftmargin=*, topsep=0mm, itemsep=0mm]      
    ...
    (Section~\ref{???}). \alex{Ideally, we should highlight some impressive numbers here.}
\end{itemize}
...
\begin{figure}[t]
    ...
    \alex{Is this figure up-to-date?}}
